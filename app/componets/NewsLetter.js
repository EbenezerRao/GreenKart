...
const NewsLetter = () => {
    return (
        <div className="w-full bg-[url('/footer.png')] bg-cover bg-center py-16 px-6 flex justify-start items-center">
            <div className="bg-white/90 rounded-2xl shadow-md p-8 sm:p-12 w-[1048px]  ">
